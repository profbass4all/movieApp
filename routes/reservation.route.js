...
const {createReservation, getReservations, getReservation, getAvailableSeats, cancelReservation, getSingleReservation} = require('../controllers/reservation.controller')
